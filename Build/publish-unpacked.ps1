...
$output = Join-Path $root "artifacts\release-unpacked"

Write-Host "========================================"
Write-Host " PB BZH License Generator WPF"
Write-Host " Publication Release non single-file"
Write-Host " Base pour obfuscation"
Write-Host "========================================"
Write-Host ""
...
Write-Host ""
Write-Host "Publication non single-file terminee."
Write-Host ""
