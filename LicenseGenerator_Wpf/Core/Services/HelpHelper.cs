using LicenseGenerator.Core.Profiles;
...
public class HelpHelper {
  ...
  public static ApplicationInfoProfile ConstruireApplicationInfoProfile(ServiceManagerProfile profile) {
  ...
  public static void mnuAbout(IWin32Window owner,ServiceManagerProfile profile) {
  ...
  public static async void mnuCheckForUpdates(IWin32Window owner,ServiceManagerProfile profile) {
